...
class DreamProjector:
    def __init__(self):
        ...
        self.initial_noise_strength     =0.075
    ...
    def start(self):
        ...
        param=np.tile(self._dlatent_avg, [self._minibatch_size, 1, 1])
        param+=np.random.normal(0,1,(self._minibatch_size,1,512))*np.tile(self._dlatent_std, [self._minibatch_size,1,1])*self.initial_noise_strength
        tflib.set_vars({self._dlatents_var: param})
